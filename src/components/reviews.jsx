...
import { HiStar, HiOutlineStar, HiTrash, HiCheckCircle, HiXCircle } from "react-icons/hi";
...
export default function Reviews({ productKey, showAddForm = true }) {
  ...
  return (
    <div className="space-y-8">
      {showAddForm && (
        <div className="rounded-3xl bg-white border border-slate-200 shadow-card p-6 md:p-8 animate-fade-in">
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      {star <= (hoverRating || rating) ? (
                        ...
                        <HiOutlineStar className="text-slate-300" />
                      )}
                    </button>
                  ))}
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {user?.role === "admin" && (
                      <div className="flex gap-2 mt-4">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-red-50 text-red-600 text-sm font-medium hover:bg-red-100 transition"
                        >
                    ...
                    {user?.email === review.email && user?.role !== "admin" && (
                      <button
                        onClick={() => handleDelete(review.email)}
                        className="mt-4 px-3 py-1.5 rounded-lg bg-red-50 text-red-600 text-sm font-medium hover:bg-red-100 transition"
                      >
                        <HiTrash className="w-4 h-4 inline mr-1" />
                        Delete My Review
                      </button>
