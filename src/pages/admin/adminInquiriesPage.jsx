...
import { HiMail, HiPhone, HiCalendar, HiCheckCircle, HiXCircle, HiTrash, HiPencil } from "react-icons/hi";
...
export default function AdminInquiriesPage() {
  ...
  return (
    <div className="p-6 md:p-8 animate-fade-in">
      <h1 className="text-3xl font-bold text-slate-900 mb-8">Customer Inquiries</h1>
      ...
      {inquiries.length === 0 ? (
        <div className="text-center py-16 rounded-3xl bg-white border border-slate-200">
          ...
          <p className="text-slate-600">No inquiries at the moment</p>
        </div>
      ) : (
