...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    setSending(true);
    setTimeout(() => {
      toast.success("Message received! We'll get back to you soon.", { icon: "✉️" });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            {[
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-2xl bg-white/20 backdrop-blur-sm">{item.icon}</div>
                  <div>
                    <p className="text-sm font-semibold opacity-90 uppercase tracking-wider mb-1">{item.label}</p>
          ...
          <div className="animate-slide-in-right">
            <form onSubmit={handleSubmit} className="rounded-3xl bg-white border border-slate-200 shadow-premium p-8 md:p-10">
