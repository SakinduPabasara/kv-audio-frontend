  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md animate-scale-in">
        <div className="text-8xl md:text-9xl font-bold text-accent/10 mb-4">404</div>
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">Page not found</h1>
