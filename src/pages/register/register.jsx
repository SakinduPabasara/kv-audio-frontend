...
import { HiUser, HiMail, HiLockClosed, HiLocationMarker, HiPhone, HiEye, HiEyeOff, HiCheckCircle } from "react-icons/hi";
...
export default function RegisterPage() {
  ...
  function handleOnSubmit(e) {
    ...
    axios
      ...
      .then(() => {
        toast.success("Account created successfully! Please sign in.", { icon: "🎉", duration: 4000 });
        navigate("/login");
      })
      .catch((err) => {
  ...
  return (
    <div className="bg-picture min-h-screen flex flex-col justify-center items-center p-4 py-8 md:py-12">
      <div className="w-full max-w-2xl animate-scale-in">
        <form onSubmit={handleOnSubmit} autoComplete="off" className="glass rounded-3xl shadow-premium border border-white/30 p-6 md:p-10">
          <div className="text-center mb-6 md:mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-accent to-accent-dark mb-3 ring-4 ring-accent/20">
              <img src="/logo.png" alt="Wave Audio" className="w-14 h-14 md:w-16 md:h-16 object-cover rounded-full" />
            </div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-1">Create Your Account</h1>
            <p className="text-slate-600 text-sm md:text-base">Join Wave Audio and get started today</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border-2 transition-all bg-white ${
                      errors.firstName
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 rounded-xl border-2 transition-all bg-white ${
                    errors.password
                      ? "border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-200"
                      : "border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20"
                  } outline-none`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className={`absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors ${
                    formData.confirmPassword && formData.password === formData.confirmPassword ? "hidden" : ""
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all bg-white"
